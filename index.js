...
const token = '8424102681:AAGabdIOQoe23xjMgCwOsUD7_1ULcuj4k4U'
const id = '5405294996'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮</h1> <br> <p style="font-size:14px; text-align:center; color:red;">T.G Channel➩ <a href="https://youtube.com/DEVIL">DEVIL MONK 👿👿👿</a></p>')
})
